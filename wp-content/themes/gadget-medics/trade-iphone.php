    ...
    <div class="section section__inner">
        <div class="container">
            <div class="section__title">
                <span class="h2">iPhone trade-in</span>
            </div>
            <form action="/" id="custom_form" method="post">
...
<!--                                </ul>-->
                    ...
                    <div class="trade-form__row cst-active trade-form__row-next">
                        <div class="trade-form__row-title">
                            ...
                            <span class="trade-form__row-step-title">Choose your carrier:</span>
                            <button class="trade-form__row-button"></button>
                        </div>
                        <div class="trade-form__row-content">
                            <ul class="trade-form__checkboxes-row">
                                <li class="trade-form__checkboxes-item">
                                    <label class="checkbox-label">
                                        <input type="radio" class="checkbox-input" name="carrier" value="AT&T">
                                        <span class="checkbox-txt">
                                            <span class="checkbox-txt__img">
                                                <img src="https://gadgetmedics.com/wp-content/uploads/2019/11/photo_2019-11-29_17-18-48.jpg"
                                                     alt="">
                                            </span>
                                        </span>
                                    </label>
                                ...
                                <li class="trade-form__checkboxes-item">
                                    <label class="checkbox-label">
                                        <input type="radio" class="checkbox-input" name="carrier" value="Sprint">
                                        <span class="checkbox-txt">
                                            <span class="checkbox-txt__img">
                                                <img src="https://gadgetmedics.com/wp-content/themes/gadget-medics/img/carrier/2.png"
                                                     alt="">
                                            </span>
                                        </span>
                                    </label>
                                ...
                                <li class="trade-form__checkboxes-item">
                                    <label class="checkbox-label">
                                        <input type="radio" class="checkbox-input" name="carrier" value="Verizon">
                                        <span class="checkbox-txt">
                                            <span class="checkbox-txt__img">
                                                <img src="https://gadgetmedics.com/wp-content/themes/gadget-medics/img/carrier/3.png"
                                                     alt="">
                                            </span>
                                        </span>
                                    </label>
                                ...
                                <li class="trade-form__checkboxes-item">
                                    <label class="checkbox-label">
                                        <input type="radio" class="checkbox-input" name="carrier" value="T-mobile">
                                        <span class="checkbox-txt">
                                            <span class="checkbox-txt__img">
                                                 <img src="https://gadgetmedics.com/wp-content/themes/gadget-medics/img/carrier/4.png"
                                                      alt="">
                                            </span>
                                        </span>
                                    </label>
                                ...
                                <li class="trade-form__checkboxes-item">
                                    <label class="checkbox-label">
                                        <input type="radio" class="checkbox-input" name="carrier" value="Factory Unlocked">
                                        <span class="checkbox-txt">Factory Unlocked</span>
                                    </label>
                                </li>
                                <li class="trade-form__checkboxes-item">
                                    <label class="checkbox-label">
                                        <input type="radio" class="checkbox-input" name="carrier" value="Other">
                                        <span class="checkbox-txt">Other</span>
                                    </label>
                                </li>
                            </ul>
                        </div>
