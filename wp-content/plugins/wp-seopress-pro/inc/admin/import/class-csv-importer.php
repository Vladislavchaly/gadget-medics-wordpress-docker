...
abstract class SEOPRESS_Importer implements SEOPRESS_Importer_Interface {
	...
	protected function process_item( $data ) {
		try {
			...
			if (isset($data['redirect_active']) && $data['redirect_active'] =='yes') {
				update_post_meta($data['id'], '_seopress_redirections_enabled', 'yes');
			}
			if (isset($data['redirect_type']) && !empty($data['redirect_type'])) {
				update_post_meta($data['id'], '_seopress_redirections_type', $data['redirect_type']);
			}
			if (isset($data['redirect_url']) && !empty($data['redirect_url'])) {
				update_post_meta($data['id'], '_seopress_redirections_value', $data['redirect_url']);
			}
