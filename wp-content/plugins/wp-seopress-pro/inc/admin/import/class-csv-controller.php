			...
			<section class="seopress-importer-done">
				...
				if ( 0 < $imported ) {
					$results[] = sprintf(
						...
						_n( '%s metadata imported', '%s metadata imported', $imported, 'wp-seopress-pro' ),
				...
				if ( 0 < $updated ) {
					$results[] = sprintf(
						/* translators: %d: posts count */
						_n( '%s metadata updated', '%s metadata updated', $updated, 'wp-seopress-pro' ),
				...
				if ( 0 < $skipped ) {
					$results[] = sprintf(
						/* translators: %d: posts count */
						_n( '%s metadata was skipped', '%s metadata were skipped', $skipped, 'wp-seopress-pro' ),
				...
				if ( 0 < $failed ) {
					$results [] = sprintf(
						/* translators: %d: posts count */
						_n( 'Failed to import %s metadata', 'Failed to import %s metadata', $failed, 'wp-seopress-pro' ),
