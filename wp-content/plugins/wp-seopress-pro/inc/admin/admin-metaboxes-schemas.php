...
if (!empty($sp_schemas_ids)) {
	...
	if ($count == 1) {
		echo '<p class="sp-schema-count seopress-notice notice notice-info" data-count="'.$count.'">'.sprintf(__('You have <strong>%d</strong> automatic schema:','wp-seopress-pro'), $count).'</p>';
	} else {
		echo '<p class="sp-schema-count seopress-notice notice notice-info" data-count="'.$count.'">'.sprintf(__('You have <strong>%d</strong> automatic schemas:','wp-seopress-pro'), $count).'</p>';
	}
	...
	if ('1' == $seopress_pro_rich_snippets_disable_all) echo 'checked="yes"';
	echo ' value="1"/>';
	echo __( 'Disable all automatic schemas for this post?', 'wp-seopress-pro' ) .'</label></p>';
	...
	foreach ($sp_schemas_ids as $id) {
		...
		//Software App
		if ($seopress_pro_rich_snippets_type == 'softwareapp') {
		...
		if ($seopress_pro_rich_snippets_type != 'none' || $seopress_pro_rich_snippets_type !='') {
			...
			if (is_array($seopress_pro_rich_snippets_disable) && array_key_exists($id, $seopress_pro_rich_snippets_disable)) echo 'checked="yes"';
			echo ' value="1"/>';
			echo __( 'Disable this automatic schema for this post?', 'wp-seopress-pro' ) .'</label></p>';
		}
		...
		if ($seopress_pro_rich_snippets_type == 'articles') {
			...
			if ($seopress_pro_rich_snippets_article_coverage_start_date == 'manual_date_single') {
				echo '<p>
			...
			if ($seopress_pro_rich_snippets_article_coverage_start_time == 'manual_time_single') {
				echo '<p>
			...
			if ($seopress_pro_rich_snippets_article_coverage_end_date == 'manual_date_single') {
				echo '<p>
			...
			if ($seopress_pro_rich_snippets_article_coverage_end_time == 'manual_time_single') {
				echo '<p>
		...
		if ($seopress_pro_rich_snippets_type == 'events') {
			...
			if ($seopress_pro_rich_snippets_events_previous_start_date == 'manual_date_single') {
				echo '<p>
			...
			if ($seopress_pro_rich_snippets_events_previous_start_time == 'manual_time_single') {
				echo '<p>
			...
			if ($seopress_pro_rich_snippets_events_status == 'manual_single') {
				echo '<p>
			...
			if ($seopress_pro_rich_snippets_events_attendance_mode == 'manual_single') {
				echo '<p>
		...
		//Software App
		if ($seopress_pro_rich_snippets_type == 'softwareapp') {
			if ($seopress_pro_rich_snippets_softwareapp_name == 'manual_single') {
				echo '<p>
			...
			if ($seopress_pro_rich_snippets_softwareapp_os == 'manual_single') {
				echo '<p>
			...
			if ($seopress_pro_rich_snippets_softwareapp_cat == 'manual_single') {
				echo '<p>
			...
			if ($seopress_pro_rich_snippets_softwareapp_price == 'manual_single') {
				echo '<p>
			...
			if ($seopress_pro_rich_snippets_softwareapp_currency == 'manual_single') {
				echo '<p>
			...
			if ($seopress_pro_rich_snippets_softwareapp_rating == 'manual_rating_single') {
				echo '<p>
						<label for="seopress_pro_schemas['.$id.'][rich_snippets_softwareapp][rating]_meta">
							'. __( 'Your rating', 'wp-seopress-pro' ) .'</label>
						<input type="number" step="0.1" min="0" max="5" id="seopress_pro_schemas['.$id.'][rich_snippets_softwareapp][rating]" name="seopress_pro_schemas['.$id.'][rich_snippets_softwareapp][rating]" placeholder="'.esc_html__('The item rating','wp-seopress-pro').'" aria-label="'.__('Your rating','wp-seopress-pro').'" value="'.esc_attr($check_softwareapp_rating).'" />
					</p>';
			}
		}
	...
	echo '<p class="seopress-notice notice notice-info">'.__('No automatic schema created for this content.','wp-seopress-pro').'</p>';
