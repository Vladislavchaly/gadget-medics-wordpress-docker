...
{
	return ['post_type' => __('Post Type', 'wp-seopress-pro'), 'taxonomy'  => __('Taxonomy')];
}
...
function seopress_schemas_cpt($post)
{
	...
	echo '<p class="seopress-help seopress-notice notice-info">' . sprintf(__('Learn more about the <strong>Article schema</strong> from the <a href="%s" target="_blank">Google official documentation website</a><span class="dashicons dashicons-external"></span>', 'wp-seopress-pro'), 'https://developers.google.com/search/docs/data-types/article') . '</p>';
	...
	if (function_exists('seopress_rich_snippets_publisher_logo_option') && '' != seopress_rich_snippets_publisher_logo_option()) {
		...
		echo '<p class="seopress-notice notice-error"><span class="dashicons dashicons-no-alt"></span>' . __('You don\'t have set a publisher logo. It\'s required for Article content types.', 'wp-seopress-pro') . '</p>';
	}
	...
	echo '<p class="seopress-notice notice-info">' . sprintf(__('Learn more about the <strong>Local Business schema</strong> from the <a href="%s" target="_blank">Google official documentation website</a><span class="dashicons dashicons-external"></span>', 'wp-seopress-pro'), 'https://developers.google.com/search/docs/data-types/local-business') . '</p>';
	echo '<p>
	...
	echo '<p class="seopress-notice notice-info">' . sprintf(__('Learn more about the <strong>FAQ schema</strong> from the <a href="%s" target="_blank">Google official documentation website</a><span class="dashicons dashicons-external"></span>', 'wp-seopress-pro'), 'https://developers.google.com/search/docs/data-types/faqpage') . '</p>';
	echo '<p>
	...
	echo '<p class="seopress-notice notice-info">' . sprintf(__('Learn more about the <strong>Course schema</strong> from the <a href="%s" target="_blank">Google official documentation website</a><span class="dashicons dashicons-external"></span>', 'wp-seopress-pro'), 'https://developers.google.com/search/docs/data-types/course') . '</p>';
	...
	echo '<p class="seopress-notice notice-info">' . sprintf(__('Learn more about the <strong>Recipe schema</strong> from the <a href="%s" target="_blank">Google official documentation website</a><span class="dashicons dashicons-external"></span>', 'wp-seopress-pro'), 'https://developers.google.com/search/docs/data-types/recipe') . '</p>';
	...
	echo '<p class="seopress-notice notice-info">' . sprintf(__('Learn more about the <strong>Job Posting schema</strong> from the <a href="%s" target="_blank">Google official documentation website</a><span class="dashicons dashicons-external"></span>', 'wp-seopress-pro'), 'https://developers.google.com/search/docs/data-types/job-posting') . '</p>';
	...
	echo '<p class="seopress-notice notice-info">' . sprintf(__('Learn more about the <strong>Video schema</strong> from the <a href="%s" target="_blank">Google official documentation website</a><span class="dashicons dashicons-external"></span>', 'wp-seopress-pro'), 'https://developers.google.com/search/docs/data-types/video') . '</p>';
	...
	echo '<p class="seopress-notice notice-info">' . sprintf(__('Learn more about the <strong>Events schema</strong> from the <a href="%s" target="_blank">Google official documentation website</a><span class="dashicons dashicons-external"></span>', 'wp-seopress-pro'), 'https://developers.google.com/search/docs/data-types/event') . '</p>';
	...
	echo '<p>
									...
									<p>
										<label for="seopress_pro_rich_snippets_events_previous_start_date_meta">
											...
											' . seopress_schemas_mapping_array('seopress_pro_rich_snippets_events_previous_start_date', 'date') . '
									</p>
									<p>
										<label for="seopress_pro_rich_snippets_events_previous_start_time_meta">
											' . __('Previous Start time', 'wp-seopress-pro') . '</label>
											' . seopress_schemas_mapping_array('seopress_pro_rich_snippets_events_previous_start_time', 'time') . '
									</p>
									<p>
									...
									<p>
										...
										' . seopress_schemas_mapping_array('seopress_pro_rich_snippets_events_offers_valid_from_date', 'date') . '
									</p>
									<p>
										<label for="seopress_rich_snippets_events_offers_valid_from_meta_time">' . __('Time', 'wp-seopress-pro') . '</label>
										' . seopress_schemas_mapping_array('seopress_pro_rich_snippets_events_offers_valid_from_time', 'time') . '
									</p>
									<p>
									...
									<p>
										<label for="seopress_pro_rich_snippets_events_status_meta">
											...
											' . seopress_schemas_mapping_array('seopress_pro_rich_snippets_events_status', 'default') . '
									...
									<p>
										<label for="seopress_pro_rich_snippets_events_attendance_mode_meta">
											...
											' . seopress_schemas_mapping_array('seopress_pro_rich_snippets_events_attendance_mode', 'default') . '
	...
	echo '<p class="seopress-notice notice-info">' . sprintf(__('Learn more about the <strong>Product schema</strong> from the <a href="%s" target="_blank">Google official documentation website</a><span class="dashicons dashicons-external"></span>', 'wp-seopress-pro'), 'https://developers.google.com/search/docs/data-types/product') . '</p>';
	...
	if (is_plugin_active('woocommerce/woocommerce.php')) {
		if (('no' == get_option('woocommerce_enable_reviews') && get_option('woocommerce_enable_reviews'))
			...
			echo '<br>' . sprintf(__('Please activate these options from <strong>WC settings</strong>, <strong>Products</strong>, <a href="%s"><strong>General tab</strong></a>:', 'wp-seopress-pro'), admin_url('admin.php?page=wc-settings&tab=products')) . '<br>';
		}
		if ('no' == get_option('woocommerce_enable_reviews') && get_option('woocommerce_enable_reviews')) {
	...
	echo '<p class="seopress-notice notice-info">' . sprintf(__('Learn more about the <strong>Service schema</strong> from the <a href="%s" target="_blank">Schema.org official documentation website</a><span class="dashicons dashicons-external"></span>', 'wp-seopress-pro'), 'https://schema.org/Service') . '</p>';
	...
	echo '<p class="description"><span class="seopress-help dashicons dashicons-external"></span>' . sprintf(__('<a href="%s" target="_blank">You can use dynamic variables in your schema.</a>', 'wp-seopress-pro'), $seopress_docs_link['support']['schema']['dynamic']) . '</p>
								</div>
							</div>
						</div>
					</div>
