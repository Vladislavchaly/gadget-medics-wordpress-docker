...
if (seopress_white_label_help_links_option() =='1') {
	if (is_seopress_page() === true) {
		function seopress_white_label_css() {
			echo '<style>.seopress-help, .seopress-doc{display:none;}</style>';
		}
...
if (is_multisite()) {
	...
	if (seopress_mu_white_label_help_links_option() =='1') {
		if (is_seopress_page() === true) {
			function seopress_white_label_css() {
				echo '<style>.seopress-help, .seopress-doc{display:none;}</style>';
			}
...
if (seopress_white_label_plugin_list_view_details_option() !='' || function_exists('seopress_mu_white_label_plugin_list_view_details_option') && seopress_mu_white_label_plugin_list_view_details_option() !='') {
	...
	function seopress_filter_plugins_list_meta( $links, $file ) {	
		if ( strpos( $file, 'wp-seopress/seopress.php' ) !== false || strpos( $file, 'wp-seopress-pro/seopress-pro.php' ) !== false ) {
			unset($links[2]);
		}
