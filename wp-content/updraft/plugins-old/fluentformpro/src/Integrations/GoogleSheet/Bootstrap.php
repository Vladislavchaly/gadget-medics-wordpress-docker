...
class Bootstrap extends IntegrationManager
{
    public function __construct(Application $app)
    {
        ...
        $this->description = 'Add Fluent Forms Submission to Google sheets when they submit a form';
    ...
    public function saveGlobalSettings($settings)
    {
        ...
        try {
            ...
            update_option($this->optionKey, $result);
    ...
    public function checkColumnSlugs($settings, $integrationId)
    {
        ...
        if(count($settings['meta_fields']) > 26) {
            $message = 'Spreadsheet Fileds can not bet greater than 26';
        }
    ...
    public function notify($feed, $formData, $entry, $form)
    {
        ...
        foreach ($metaFields as $field) {
            $row[] = esc_html(ArrayHelper::get($field, 'item_value'));
        }
