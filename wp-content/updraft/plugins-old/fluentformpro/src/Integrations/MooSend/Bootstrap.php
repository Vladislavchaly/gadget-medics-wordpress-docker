...
//        add_filter('fluentform_notifying_async_moosend', '__return_false');
    ...
    public function getGlobalFields($fields)
    {
        return [
            ...
            'menu_description' => __('MooSend is email marketing software. Use Fluent Form to collect customer information and automatically add it as ConvertKit subscriber list.', 'fluentformpro'),
            ...
            'fields'           => [
                'apiKey' => [
                    'type'        => 'password',
                    'placeholder' => 'API Key',
                    'label_tips'  => __("Enter your MooSend API Key, if you do not have <br>Please login to your MooSend account and go to<br>Account -> Appi Key", 'fluentformpro'),
