=== WordPress Robots.txt optimization (+ Sitemap) – Website traffic, ranking & SEO Booster + Woocommerce ===
...
Better Robots.txt is an all in one SEO robots.txt plugin, it creates a WordPress virtual robots.txt including your XML sitemaps (Yoast or else) to boost your website ranking on search engines.
...
Reduce your [site's ecological footprint and the greenhouse gas (CO2) production](https://better-robots.com/how-to-save-the-planet-with-your-website/) inherent to its existence on the Web.
...
= How can this plugin boost my website ranking? =
