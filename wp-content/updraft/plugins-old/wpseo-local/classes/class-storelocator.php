				...
				<fieldset>
					...
					<p>
						...
						if ( true === wpseo_may_use_current_location() ) {
							echo ' <a href="javascript:" class="wpseo_use_current_location" data-target="wpseo-sl-search"><img src="' . esc_url( plugins_url( 'images/location-icon.svg', WPSEO_LOCAL_FILE ) ) . '" class="wpseo_use_current_location_image" height="24" width="24" alt="' . esc_attr__( 'Use my current location', 'yoast-local-seo' ) . '" data-loading-text="' . esc_attr__( 'Determining current location', 'yoast-local-seo' ) . '"></a> ';
						}
